...
export function registerIpc(mainWindow: BrowserWindow, app: Electron.App) {
  ...
  ipcMain.handle(IpcChannel.Mcp_RemoveServer, mcpService.removeServer.bind(mcpService))
  ipcMain.handle(IpcChannel.Mcp_RestartServer, mcpService.restartServer.bind(mcpService))
  ipcMain.handle(IpcChannel.Mcp_StopServer, mcpService.stopServer.bind(mcpService))
  ipcMain.handle(IpcChannel.Mcp_ListTools, mcpService.listTools.bind(mcpService))
  ipcMain.handle(IpcChannel.Mcp_CallTool, mcpService.callTool.bind(mcpService))
  ipcMain.handle(IpcChannel.Mcp_ToolCallProgress, mcpService.callToolWithProgress.bind(mcpService))
  ipcMain.handle(IpcChannel.Mcp_ListPrompts, mcpService.listPrompts.bind(mcpService))
  ipcMain.handle(IpcChannel.Mcp_GetPrompt, mcpService.getPrompt.bind(mcpService))
  ipcMain.handle(IpcChannel.Mcp_ListResources, mcpService.listResources.bind(mcpService))
  ipcMain.handle(IpcChannel.Mcp_GetResource, mcpService.getResource.bind(mcpService))
  ipcMain.handle(IpcChannel.Mcp_GetInstallInfo, mcpService.getInstallInfo.bind(mcpService))
