...
import { MultiSelectProvider } from './Messages/MessageSelectContext'
...
const Chat: FC<Props> = (props) => {
  ...
  return (
    <Container id="chat" className={messageStyle}>
      <MultiSelectProvider topic={props.activeTopic}>
        <Main ref={mainRef} id="chat-main" vertical flex={1} justify="space-between" style={{ maxWidth }}>
          ...
          <QuickPanelProvider>
            ...
            <MultiSelectActionPopup topic={props.activeTopic} />
          </QuickPanelProvider>
        </Main>
